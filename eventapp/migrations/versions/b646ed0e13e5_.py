...
Revision ID: b646ed0e13e5
Revises: 
Create Date: 2025-09-13 01:31:53.285112
...
def upgrade():
    ...
    sa.Column('payment_method', sa.Enum('vnpay', 'momo', name='paymentmethod'), nullable=False),
